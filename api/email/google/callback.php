<?php
/**
 * Google Workspace mail OAuth callback.
 */
...
try {
    ...
    $mailService = new GoogleWorkspaceMailService();
    ...
    $integrationService->storeGoogleWorkspaceIntegration(
    ...
    header('Location: ' . $redirectUrl . '&success=google_workspace_connected#connect-apps');
    exit;
} catch (\Throwable $e) {
