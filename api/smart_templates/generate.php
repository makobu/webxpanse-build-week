...
try {
    ...
    $result = $service->generateForUser((int) ($user['id'] ?? 0), [
        'as_candidate' => true,
        'generation_mode' => 'manual_candidate',
        'generated_reason' => 'manual_review_candidate',
    ]);
    ...
    error_log('Smart template generation failed: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['error' => 'Failed to generate smart templates']);
}
