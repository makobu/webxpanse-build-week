...
if ($challengeToken === '' || $secret === '' || $code === '') {
    mobileJson(['error' => 'Challenge token, secret, and verification code are required.'], 422);
}

try {
    $session = mobileService()->verifyTwoFactorSetup($challengeToken, $secret, $code, [
