...
$source = __DIR__ . '/../docs/sql-dump-vs-migrations-guide.md';
$output = __DIR__ . '/../docs/sql-dump-vs-migrations-guide.pdf';
...
function renderMarkdownToHtmlSimple(string $markdown): string
{
    $lines = preg_split("/\r\n|\n|\r/", $markdown) ?: [];
    $html = [];
    $inList = false;
...
$html = renderMarkdownToHtmlSimple($markdown);

$pdf = new TCPDF('P', 'mm', 'A4', true, 'UTF-8', false);
$pdf->SetCreator('CRM');
$pdf->SetAuthor('Codex');
$pdf->SetTitle('SQL Dump vs Migration Scripts');
$pdf->SetSubject('Recommended database delivery model');
