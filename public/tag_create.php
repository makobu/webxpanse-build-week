...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!Security::validateCSRF($_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            $error = 'The tag could not be created. Please try again.';
        }
    }
}
...
$pageTitle = 'Create Tag - ' . brandProductName();
ob_start();
?>
    ...
    <div class="container">
        <div class="admin-form-page">
            <div class="admin-hero">
                <div>
                    <h1>Create Tag</h1>
                    <p>Create a new tag to organize your data</p>
                </div>
            ...
            <form method="POST" action="tag_create.php" class="admin-form-card">
                <input type="hidden" name="csrf_token" value="<?php echo Security::getCsrfToken(); ?>">

                <section class="admin-form-section">
                    <div class="admin-form-section-header">
                        <h2>Tag Details</h2>
                        <p>Name the tag and add optional context for your team.</p>
                    </div>
                    <div class="form-group">
                        ...
                        >
                        <small class="admin-help-text">Tag names must be unique</small>
                    </div>

                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea id="description" name="description" rows="3" placeholder="Optional description for this tag..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                    </div>
                </section>
                ...
                <section class="admin-form-section">
                    <div class="admin-form-section-header">
                        <h2>Color</h2>
                        <p>Choose a preset or enter a custom hex color.</p>
                    </div>
                        ...
                        <?php foreach ($colorOptions as $color => $label): ?>
                            <label class="utility-color-option">
                                <input
                                    ...
                                    <?php echo (($_POST['color'] ?? '#33cc33') === $color) ? 'checked' : ''; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="color"
                            name="color"
                            value="<?php echo htmlspecialchars($_POST['color'] ?? '#33cc33'); ?>"
                            placeholder="#33cc33"
                            pattern="^#[0-9A-Fa-f]{6}$"
                        >
                        <small class="admin-help-text">Or enter a custom hex color (e.g., #FF5733)</small>
                    </div>
                </section>
...
// Update radio when text input changes
